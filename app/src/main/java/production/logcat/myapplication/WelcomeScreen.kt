...
import production.logcat.myapplication.adapter.WelcomePageAdapter
import production.logcat.myapplication.models.phoneLogin
import production.logcat.myapplication.models.phoneSignUp
import production.logcat.myapplication.models.usernameSignUp
    ...
    private fun verifyPhoneNumber(viewOfPage:View,username:String,phoneNumber:String,authType:String){
        ...
        val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                progressDialog.cancel()
                val action=WelcomeScreenDirections.actionWelcomeScreenToVerificationScreen()
