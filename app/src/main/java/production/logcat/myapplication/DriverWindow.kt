...
import production.logcat.myapplication.adapter.DriverAdapter
import production.logcat.myapplication.models.DriverModel
import production.logcat.myapplication.models.FireDriverModel
...
class DriverWindow : Fragment() {
    ...
    private val argsInDriversWindow: DriverWindowArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_driver_window, container, false)
    }
    ...
    private fun getDriverDistance(lat1: Double, lon1: Double, lat2: Double, lon2: Double): String {
            ...
            when {
                ...
                result.compareTo("ERROR")==0 -> {
                    ...
                    allDriverDoc?.keys?.forEach {
                        ...
                        driverList.add(
                                DriverModel(it.toString(),driverDistance,eachDriverData.imageUrl, eachDriverData.username, eachDriverData.age, eachDriverData.workingTime, eachDriverData.phone, eachDriverData.autoNumber,bookWithSendMessage = { driverDetails, nomineeNumber ->
