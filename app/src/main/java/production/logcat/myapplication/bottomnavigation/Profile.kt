...
import production.logcat.myapplication.MainActivity
...
class Profile : Fragment() {
    ...
    private fun setData(){
        if(customerObject!!.imageUrl.compareTo("no image")==0){ profileImage.setImageDrawable(
            resources.getDrawable(R.drawable.profileicon)
        ) }
                        ...
                        when (!isChanged.isSuccessful) {
                            true -> {
                                ...
                                if (customerObject!!.imageUrl.compareTo("no image") == 0) {
                                    profileImage.setImageDrawable(resources.getDrawable(R.drawable.profileicon))
                                } else {
